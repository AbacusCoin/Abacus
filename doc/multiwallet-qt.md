...
In order to support loading of multiple wallets in aba-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is aba.cpp.
...
Changes to aba.cpp
----------------------
aba.cpp is the entry point into aba-qt, and as such, will require some minor modifications to provide hooks for
