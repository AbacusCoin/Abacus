...
ccbcd/aba-cli binaries are not included in the aba-Qt.app bundle.

If you are building `ccbcd` or `aba-qt` for others, your build machine should be set up
...
-------
    ...
    ./ccbcd -daemon # to start the aba daemon.
