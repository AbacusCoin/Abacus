Contributing to Aba Core
============================

The Aba Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Aba Core project, and is not to be
confused with overall Aba Network Protocol consensus changes.

Whether a pull request is merged into Aba Core rests with the project merge
...
Patches that change Aba consensus rules are considerably more involved than
...
Where a patch set proposes to change the Aba consensus, it must have been
...
The project leader is the release manager for each Aba Core release.
