...
<context>
    ...
    <message>
        ...
        <translation>Aba will close now to finish the encryption process. Remember that encrypting your wallet cannot fully protect your ABAs from being stolen by malware infecting your computer.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>If the custom fee is set to 1000 uABAs and the transaction is only 250 bytes, then "per kilobyte" only pays 250 uABAs in fee,&lt;br /&gt;while "at least" pays 1000 uABAs. For transactions bigger than a kilobyte both pay by kilobyte.</translation>
    </message>
    <message>
        ...
        <translation>If the custom fee is set to 1000 uABAs and the transaction is only 250 bytes, then "per kilobyte" only pays 250 uABAs in fee,&lt;br /&gt;while "total at least" pays 1000 uABAs. For transactions bigger than a kilobyte both pay by kilobyte.</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "Aba Alert" admin@foo.com
        ...
        <translation>To use abad, or the -server option to aba-qt, you must set an rpcpassword in the configuration file:
%s
It is recommended you use the following random password:
rpcuser=abarpc
rpcpassword=%s
