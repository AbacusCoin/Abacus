...
spinnerFrame(0)
{
	...
	QString windowTitle = tr("ABA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
	...
	sendCoinsAction->setStatusTip(tr("Send coins to a ABA address"));
	...
	receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aba: URIs)"));
	...
	privacyAction->setStatusTip(tr("Privacy Actions for zABA"));
	...
	aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ABA Core"), this);
	aboutAction->setStatusTip(tr("Show information about ABA Core"));
	...
	optionsAction->setStatusTip(tr("Modify configuration options for ABA"));
	...
	signMessageAction->setStatusTip(tr("Sign messages with your ABA addresses to prove you own them"));
	verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
	verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ABA addresses"));
	...
	openAction->setStatusTip(tr("Open a ABA: URI or payment request"));
	openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
	openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

	showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
	showHelpMessageAction->setMenuRole(QAction::NoRole);
	showHelpMessageAction->setStatusTip(tr("Show the ABA Core help message to get a list with possible ABA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
	...
	QString toolTip = tr("ABA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
	...
	labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ABA network", "", count));
}
...
{
	QString strTitle = tr("ABA Core"); // default title
