...
static const Checkpoints::CCheckpointData data = {
	&mapCheckpoints,
	1539355914, // * UNIX timestamp of last checkpoint block
...
public:
	CMainParams()
	{
		...
		vReviveRewardAddress = "AeWxSSRz1bt25DqvcCdmVTDiDqZFHQxpNS";   //Marketing Funds
		vTreasuryRewardAddress = "AJT4joF7AYRRxcwTB8xwMid24h64ku7HSH"; //Dev Fee
		strNetworkID = "main";
		/**
		...
		*/
		...
		genesis.nVersion = 1;
		genesis.nTime = 1539355914;
		genesis.nBits = 504365040;
		genesis.nNonce = 1286385;
		...
		strSporkKey = "03c7e21a90238f2179622466693dc9b9df1d2e59a0d3af23ae8904f29220a61d72";
		strObfuscationPoolDummyAddress = "XCNAsFGy8k7amqRG26ikKyfVDwK8585Z6b";
        	nStartMasternodePayments = 1539355914;
